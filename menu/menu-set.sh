...
echo -e "     ${BICyan}[${BIWhite}10${BICyan}] Cek Status Vps "
echo -e "     ${BICyan}[${BIWhite}11${BICyan}] Clear Ram Cache "
...
9) clear ; bw ; exit ;;
10) clear ; running ; exit ;;
11) clear ; clearcache ; exit ;;
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "Salah Pilih Sayank.. !!" ; sleep 1 ; menu-set ;;
esac
